...
TabsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"D:\DA\MxvMobile\src\pages\tabs\tabs.html"*/'<ion-tabs color="mxv-blue">\n\n  <ion-tab *ngFor="let tab of listTabsPage" [root]="tab.root" [tabTitle]="tab.title" [tabIcon]="tab.icon"></ion-tab>\n\n</ion-tabs>'/*ion-inline-end:"D:\DA\MxvMobile\src\pages\tabs\tabs.html"*/,
    })
], TabsPage);
